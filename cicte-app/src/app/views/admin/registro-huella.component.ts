...
@Component({
  selector: 'app-registro-huella',
  templateUrl: './registro-huella.component.html'
})
export class RegistroHuellaComponent implements OnInit {

  @ViewChild('registro') childOne: SelecionarHuellaComponent;
